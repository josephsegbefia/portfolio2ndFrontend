    ...
    <div>
      <section className="flex flex-col justify-start items-center p-4 text-center">
        ...
        <p className=" font-light text-gray-500 dark:text-white">
          I am a skilled professional with a background in marine engineering,
          data science and machine learning. I have developed a unique set of
          skills that enable me to solve complex problems, analyse data, and
          write clean, efficient code, because of my diverse background. I
          recently completed an intensive bootcamp in web development and I am
          eager, and passionate about leveraging my expertise to create
          innovative web solutions that drive business success. With my strong
          attention to detail, I strive deliver high-quality work that meets and
          exceeds client expectation. My goal is to make a positive impact in
          the web development industry by pushing the boundaries of what is
          possible.
        </p>
        <br />
      </section>
      ...
      <section className="flex flex-col justify-start p-6">
        <ol className="relative border-l border-gray-200 dark:border-gray-700 p-4">
          ...
          <li className="mb-10 ml-4">
            ...
            <p className="text-base font-normal text-gray-500 dark:text-gray-400">
              ...
              Matplotlib, and many more. <br />- Worked with real-world datasets
              to learn the statistical and machine learning techniques needed to
              train decision trees and use natural language processing (NLP)
            </p>
        ...
        <div className="min-w-fit p-4 flex flex-col justify-start items-center py-16 px-5 text-center shadow-lg dark:shadow-gray-100 rounded-xl duration-300 mt-20 ease-in-out hover:scale-110">
          ...
          <p className="mb-5 text-base">
            Please take some time to have a look at some of my projects. Mostly
            built with the MERN stack. I also have a few data science projects
            in there as well
          </p>
